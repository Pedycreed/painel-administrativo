...
import { useDashboardRedirect } from "@/lib/teamGuard"
...
export default function DashboardPage() {
  ...
  async function loadObras() {
    try {
      const data = await apiGet<Obra[]>("/obras/")
      setObras(data)
    } catch (e) {
      ...
      <div className="px-6 py-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <Card className="bg-[oklch(0.12_0_0)] border-border">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <p className="text-[oklch(0.55_0_0)] text-sm">Total Obras</p>
          ...
          <Card className="bg-[oklch(0.12_0_0)] border-border">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <p className="text-[oklch(0.55_0_0)] text-sm">Total Capítulos</p>
          ...
          <Card className="bg-[oklch(0.12_0_0)] border-border">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <p className="text-[oklch(0.55_0_0)] text-sm">Total Páginas</p>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-base font-semibold text-foreground">Obras Recentes</h2>
          </div>
          ...
          <div className="bg-[oklch(0.12_0_0)] border border-border rounded-lg overflow-hidden">
            <Table>
              ...
              <TableBody>
                {obras.map((obra) =>
                  (obra.capitulos || []).map((cap) => (
                    <TableRow key={cap.id} className="border-border">
                      <TableCell className="text-foreground">{obra.titulo}</TableCell>
                      <TableCell className="text-primary">#{cap.numero}</TableCell>
                      <TableCell>
                ...
                {obras.every((o) => !o.capitulos || o.capitulos.length === 0) && (
                  <TableRow>
                    <TableCell colSpan={4} className="text-center text-[oklch(0.55_0_0)] py-8">
